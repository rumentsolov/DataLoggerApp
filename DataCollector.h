...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label11->Text = L"œ–»¬≈ƒ≈Õ¿ ÃŒŸÕŒ—“";
			// 
			// label12
			// 
			...
			this->label14->Text = L" ŒÃ¡»Õ»–¿Õ¿ ÃŒŸÕŒ—“";
			// 
			// label15
			// 
			...
			this->label21->Text = L"Œ◊¿ ¬¿Õ» —–≈ƒÕ» —“Œ…ÕŒ—“»";
			// 
			// DataLogger
			// 
...
#pragma endregion
	private: System::Void btnSTOP_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		MessageBox::Show("”ÒÔÂ¯ÌÓ Á‡Ô‡Á‚‡ÌÂ Ì‡ ‰‡ÌÌËÚÂ !");
